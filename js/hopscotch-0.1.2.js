        ...
        */
        setPosition: function (step) {
          ...
          arrowEl = this.arrowEl;
            ...
            //SET BUBBLE POSITION
            if (step.alignment === 'left' && (step.placement === 'top' || step.placement === 'bottom')) {
                step.arrowOffset = 'right';
                step.xOffset = 'left';
            }
            else if (step.alignment === 'right' && (step.placement === 'top' || step.placement === 'bottom')) {
                step.arrowOffset = 'left';
                step.xOffset = 'right';
            }
            else if (step.alignment === 'center' && (step.placement === 'top' || step.placement === 'bottom')) {
                step.arrowOffset = 'center';
                step.xOffset = 'center';
            }
            else if (step.alignment === 'top' && (step.placement === 'left' || step.placement === 'right')) {
                step.arrowOffset = 'bottom';
                step.yOffset = 'top';
            }
            else if (step.alignment === 'bottom' && (step.placement === 'left' || step.placement === 'right')) {
                step.arrowOffset = 'top';
                step.yOffset = 'bottom';
            }
            else if (step.alignment === 'center' && (step.placement === 'left' || step.placement === 'right')) {
                step.arrowOffset = 'center';
                step.yOffset = 'center';
            }

            // SET (OR RESET) ARROW OFFSETS
            if (step.arrowOffset !== 'center' && step.arrowOffset !== 'right' && step.arrowOffset !== 'bottom') {
            ...
            if (!arrowOffset) {
                ...
                if (arrowOffset === 'center') {
                    ...
                    arrowEl.style.left = bubbleWidth - bubblePadding + 'px';
                }
                else {
                    // Numeric pixel value
                ...
                if (arrowOffset === 'center') {
                    ...
                    arrowEl.style.top = bubbleHeight / 2  - arrowEl.offsetHeight / 2 + 'px';
                }
                else if (arrowOffset === 'bottom') {
                    bubbleHeight = bubbleHeight || el.offsetHeight;
                    arrowEl.style.top = bubbleHeight - bubblePadding - arrowEl.offsetHeight + 'px';
                }
                else {
                    // Numeric pixel value
            ...
            if (step.xOffset === 'center') {
                ...
                left = boundingRect.left - bubbleWidth + bubblePadding;
            }
            else {
            ...
            if (step.yOffset === 'center') {
                ...
                bubbleHeight = bubbleHeight || el.offsetHeight;
                top = boundingRect.bottom - bubbleHeight + bubblePadding;
            }
            else {
